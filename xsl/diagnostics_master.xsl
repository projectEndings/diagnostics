...
<xsl:stylesheet 
    ...
    <xd:doc scopy="component">
        <xd:desc>This ridiculous regex is generated from the IANA Language 
        Subtag Registry, and is designed to check for incorrect values
        ...
        and extension tags that may appear at the end.</xd:desc>
    </xd:doc>
